!(function (a) {
  ...
  function c(b, c, d) {
    var g = a.Event(c, t);
    a.event.trigger(g, { originalEvent: b }, b.target),
      g.isDefaultPrevented() && b.preventDefault(),
      d &&
        (a.event.remove(r, p + "." + q, e), a.event.remove(r, o + "." + q, f));
  }
  function d(d) {
  ...
  function e(d) {
    return (
      ...
      (t.adx = Math.abs(t.dx)),
      (t.ady = Math.abs(t.dy)),
      (g = t.adx > u.motionThreshold || t.ady > u.motionThreshold)
        ? (clearTimeout(j),
          t.orientation ||
            (t.adx > t.ady
              ? ((t.orientation = "horizontal"),
                (t.direction = t.dx > 0 ? 1 : -1))
              : ((t.orientation = "vertical"),
                (t.direction = t.dy > 0 ? 1 : -1))),
          d.target !== s.target
            ? ((d.target = s.target),
              void f.call(this, a.Event(o + "." + q, d)))
            : void c(d, "drag"))
        : void 0
    );
  }
    ...
    var b = function () {
      ...
      (b.settings = {
        ...
        (b.init = function (f, h) {
          ...
          i && i.length > 0
            ? ("transform-slide" == i
                ? (b.settings.flick_animation = "transform-slide")
                : "transition-slide" == i
                ? (b.settings.flick_animation = "transition-slide")
                : "jquery-slide" == i
                ? (b.settings.flick_animation = "jquery-slide")
                : "scroller-slide" == i &&
                  (b.settings.flick_animation = "scroller-slide"),
              d.addClass("animate-" + i))
          ...
          if (
            ...
            void 0 != $data_dot_alignment &&
              ("left" == $data_dot_alignment
                ? (m = "left")
                : "right" == $data_dot_alignment && (m = "right")),
              ...
              void 0 != $data_auto_flick &&
                (b.settings.auto_flick = 0 != $data_auto_flick ? !0 : !1),
              b.auto_flick_start(),
              b.flick_flicker(),
          ...
          Modernizr.touch &&
            d.on("drag", function (a) {
              0 == g &&
                ...
                (a.preventDefault(),
                1 == a.direction
                  ? (c--, 0 > c ? (c = 0) : ((g = !0), b.move_flicker(c)))
                  : (c++,
                    c == e ? (c = e - 1) : ((g = !0), b.move_flicker(c))));
            });
        }),
